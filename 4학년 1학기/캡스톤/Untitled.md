...
- 저희 프로젝트는 반응형 웹사이트로 개발 중이기 때문에 데스크탑뿐만 아니라 모바일 브라우저에서도 개발 도중 테스트를 해보아야 할 필요가 있었음. 때문에 개발 초기단계부터 인프라를 먼저 구축 후 배포해보자고
...
- 우리 웹사이트에서 사용하는 이미지 파일들은 amazon s3에 업로드하도록 구성하였고 백엔드에서 필요한 state(=데이터)들은 amazon rds를 통해 mysql을 사용하고 있습니다
- 
- muckgymma.kro.kr라는 도메인을 사서 사용 중
- db테이블
